...
import { UtilisateurDeleteDialogComponent } from 'app/entities/utilisateur/utilisateur-delete-dialog.component';
  ...
  describe('Utilisateur Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [UtilisateurDeleteDialogComponent]
      })
